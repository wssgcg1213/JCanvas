        ...
        value: function dispatchMouseEvent(type, x, y) {
            ...
            for (var _i = this.children.length; _i >= 0; _i--) {
                ...
                if (isMouseover(child)) {
                    ...
                    try {
                        for (var _iterator4 = child.eventListener[type][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
